...
if __name__ == '__main__':
    ...
    parser.add_argument('--retain_batch', help='batch size of retaining prompt during training', type=int, required=False, default=1)
    ...
    parser.add_argument('--iterations', help='iterations used to train', type=int, required=False, default=300)
    parser.add_argument('--save_interval', help='iterations used to train', type=int, required=False, default=100)
